...
export default function DiamondBranches() {
  ...
  return (
    <>
      ...
      <div 
        ref={containerRef}
        className="flex items-center justify-center min-h-[400px] sm:min-h-[500px] md:min-h-[480px] pt-0 sm:pt-6 md:pt-8 pb-4 sm:pb-6 md:pb-8 px-4 md:px-0 overflow-hidden -mt-20 sm:mt-0"
      >
